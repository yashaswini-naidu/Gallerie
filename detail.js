...
function loadDetail(data) {
    ...
    document.getElementById('username_text').innerText = data.user.username;
    ...
    // Format the date
    const formattedDate = createdAt ? `${createdAt.getDate()}/${createdAt.getMonth() + 1}/${createdAt.getFullYear()}` : 'Unknown date';
        document.getElementById('upload_date').innerText = `Uploaded on: ${formattedDate}`;
